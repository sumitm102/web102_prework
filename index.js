...
const totalFundedGames = GAMES_JSON.reduce(
  (acc, game) => (game.pledged >= game.goal ? acc + 1 : acc),
  0
);

// create a string that explains the number of unfunded games using the ternary operator
const isGamePlural = totalUnfundedGames > 1 ? "games" : "game";
const isRemainPlural = totalUnfundedGames > 1 ? "remain" : "remains";

const displayStr = `A total of $${totalRaised.toLocaleString(
  "en-US"
)} has been raised for ${totalGames} games. Currently, ${totalUnfundedGames} ${isGamePlural} ${isRemainPlural} unfunded. We need your help to fund these amazing games!`;

// create a new DOM element containing the template string and append it to the description container
const additionDescription = document.createElement("p");
additionDescription.innerHTML = displayStr;
descriptionContainer.append(additionDescription);
